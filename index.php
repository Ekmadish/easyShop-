...
style="background-image: url(src/img/bc.jpg);"
 id="top">
    ...
    if ($resultfirst->num_rows > 0) {
      ...
      while($rowfirst = $resultfirst->fetch_assoc()) {
          ...
          <div class="container-fluid center-align categories">
            <a href="#category" class="button-rounded btn-large waves-effect waves-light">Категориялар</a>
              ...
              <div class="container-fluid about" id="about">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col s12 m6">
                      <h3 class="animated slideInUp wow">Кеңсе тауарлары</h3>
                      <div class="divider animated slideInUp wow"></div>
                      <p class="animated slideInUp wow">XIX ғасырдан бастап, кеңсе тауарлары (әсіресе жазуға арналған керек-жарақтар)этикеттің маңызды бөлігіне айналды; мысалы, үйлену тойына шақыру қағазын жіберу, кейбір жағдайларда оларды қолдану өте көп таралған, ал бұрын ол қорлану деп саналды. Осы мінез-құлық ережелерінің көбін кеңсе керек-жарақтарының өндірушілері ойлап табуы мүмкін,
                       мысалы, «Crane’s Blue Book of Stationery»  кітабы Crane & Co компаниясымен байланысты.</p>
                      </div>

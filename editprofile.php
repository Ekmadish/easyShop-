      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="editprofile" class="breadcrumb">Профильді өңдеу</a>
          </div>
        </div>
      </nav>
    </div>
   ...
   <form class="col s12" method="POST" >
     <div class="row">
       ...
       <div class="input-field col s12">
         ...
         <label for="icon_prefix">Жаңа Құпия Сөз</label>
       </div>
       ...
       <div class="input-field col s12 meh">
         ...
         <label for="icon_prefix">Құпия сөзді Растау</label>
           ...
           <div class="center-align">
               <button type="submit" id="confirmed" name="update" class="btn meh button-rounded waves-effect waves-light ">Жіберу</button>
           </div>

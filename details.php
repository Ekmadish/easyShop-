<?php
 ...
 <div class="container print">
   <table>
      <thead>
        <tr>
            <th data-field="name">Элемент атауы</th>
            <th data-field="category">саны</th>
            <th data-field="price">бағасы</th>
            <th data-field="quantity">қолданушы</th>
      ...
      <div class="left-align">
        ...
        ?>
        <h5>Шот-фактура #<?= $idcmd; ?></h5>
      </div>
      </tbody>
    </table>
    <div class="right-align">
      <p>Бізге сенім білдіргеніңіз үшін рахмет © кеңсе тауарлары Inc <?= date('Y'); ?></p>
    </div>

    <form method="post">
      <button type="submit" name="done" class="button-rounded waves-effect waves-light btn">Үйге</button>

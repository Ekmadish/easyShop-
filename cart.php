     ...
     <table class="highlight">
        <thead>
          <tr>
              ...
              <th data-field="category">Санат</th>
              <th data-field="price">Бағасы</th>
              <th data-field="quantity">Саны</th>
              <th data-field="total">Барлығы</th>
          </tr>
        </thead>
        <tbody>
          <?php
...
WHERE command.id_produit = product.id AND product.id_category = category.id AND command.statut = 'ordered'";
          ...
          <tr>
            ...
            <td><a href="deletecommand.php?id=<?= $id_productdb; ?>"><i class="material-icons red-text">жабу</i></a></td>
          </tr>
        <?php }}?>
        </tbody>
      </table>
      <div class="right-align">
        ...
        төлем <i class="material-icons right"></i></a>
      </div>
   </div>
   <?php

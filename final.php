       ...
       <nav>
         <div class="nav-wrapper">
           <div class="col s12">
             ...
             <a href="final" class="breadcrumb">Рақмет сізге</a>
           </div>
         </div>
       </nav>
     </div>
...
<div class="container thanks">
  ...
  <div class="card center-align">
     ...
     <div class="card-content center-align">
       <h5>Сатып алғаныңыз үшін рахмет</h5>
       <p>Сіздің тапсырысыңыз жолға шықты Құрметті: <h5 class="green-text"><?php echo"$firstname_sess". " " . "$lastname_sess";  ?></h5></p>
     </div>
   </div>

   <div class="center-align">
     <a href="details.php" class="button-rounded blue btn waves-effects waves-light">Егжей</a>
     <a href="index" class="button-rounded btn waves-effects waves-light">Үйге</a>
   </div>
  </div>
  <div class="col s12 m3">

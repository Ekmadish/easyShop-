      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="category.php?id=<?= $id_category; ?>" class="breadcrumb">Санат</a>
          </div>
        </div>
      </nav>
    </div>
      ...
      <div class="col s12 m10 ">
        <div class="container content">
          <div class="center-align">
            <button class="button-rounded btn-large waves-effect waves-light">Өнімдер</button>
          </div>
        <div class="row">
          <?php
          //get products
                    ...
                    <div class="card-image">
                      ...
                      <div class="card-action">
                        <div class="container-fluid">
                          <h5 class="white-text"><?= $price_product; ?> TG</h5>
                        </div>
                      </div>
                  </div>
                </div>

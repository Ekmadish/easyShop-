      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="infoproduct" class="breadcrumb">Өнімдер</a>
            <a href="editproduct" class="breadcrumb">Командалар</a>
          </div>
        </div>
      </nav>
    </div>
  ...
  <table class="highlight striped">
     <thead>
       <tr>
           ...
           <th data-field="user">Пайдаланушы</th>
           <th data-field="statut">Күй</th>

   ...
   <div class="container current-page">
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            <a href="../index" class="breadcrumb">Кеңсе тауарлары</a>
  ...
  <div class="row">
           ...
           <div class="card horizontal">
             ...
             <div class="card-stacked">
              <div class="card-content">
                <p>Өнімдер мен командалар</p>
              </div>
               <div class="card-action">
                 <a href="infoproduct" class="blue-text">Көбірек</a>
               </div>
             </div>
           </div>
         </div>
        ...
        <div class="card-content">
          <p>Қор</p>
             ...
             <div class="card-action">
               <a href="products" class="blue-text">Көбірек</a>
             </div>
             </div>
           ...
           <div class="card horizontal">
             ...
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a href="allusers" class="blue-text">Көбірек</a>
               </div>
             </div>
           </div>
         </div>
         ...
         <div class="col s12 m4">
           <div class="card horizontal red lighten-1">
             <div class="card-stacked">
              <div class="card-content">
                <h5 class="white-text"><i class="material-icons left">supervisor_account</i>Жалпы пайдаланушылар</h5>
              </div>
               <div class="card-action">
         ...
         <div class="col s12 m4">
           <div class="card blue lighten-1 horizontal">
             <div class="card-stacked">
              <div class="card-content">
                <h5 class="white-text"><i class="material-icons left">shopping_cart</i> Жалпы тапсырыстар</h5>
              </div>
               <div class="card-action">
         ...
         <div class="col s12 m4">
           <div class="card green lighten-1 horizontal">
             <div class="card-stacked">
              <div class="card-content">
                <h5 class="white-text"><i class="material-icons left">shopping_cart</i> Жалпы төлемдер</h5>
              </div>
               <div class="card-action">
